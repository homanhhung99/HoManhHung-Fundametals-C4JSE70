...
let reload = document.getElementById('redload')
let randomText = document.getElementById('ramdom')
var randomClick 
reload.addEventListener('click',()=>{
    randomClick = text[Math.floor(Math.random() * text.length)]
    random.innerHTML = `<div id="textone">${randomClick.quoteText}</div><div id="name">${randomClick.quoteAuthor}</div>`
})